...
fn elements_address(
    ...
    match script_type {
        ...
        ScriptType::P2wpkh => {
            elements::Address::p2wpkh(public_key, Some(blinding_pub), addr_params)
        }
        ScriptType::P2pkh => elements::Address::p2pkh(public_key, Some(blinding_pub), addr_params),
    }
}
...
fn internal_sign_bitcoin(
    ...
    let (script_sig, witness) = match script_type {
        ...
        ScriptType::P2wpkh => (Script::new(), vec![signature, pk]),
        ScriptType::P2pkh => (
            script::Builder::new()
